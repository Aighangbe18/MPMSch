...
const RegisterPage = () => {
  return (
    <div className="relative min-h-screen text-white font-sans overflow-hidden">
      {/* Background Image */}
      <div className="absolute inset-0 bg-cover bg-center z-0 brightness-50" style={{ backgroundImage: "url('/images/music-bg.jpg')" }} />
      ...
      <div className="relative z-10 p-6 md:p-12">
        <motion.div
          ...
          animate="visible"
          variants={fadeUp}
          className="max-w-4xl mx-auto bg-black/60 rounded-2xl shadow-2xl p-6 md:p-12 space-y-10 border border-white/10 backdrop-blur-md"
        >
          {/* Title */}
          <motion.h1
            variants={fadeUp}
          ...
          <motion.div variants={fadeUp} custom={4} className="space-y-3">
            ...
            <ul className="list-disc pl-6 space-y-1 text-white/90">
              <li>2 hours weekly – <strong className="text-green-400">₦160,000.00 per month</strong></li>
              <li>1 hour weekly – <strong className="text-green-400">₦80,000.00 per month</strong></li>
              <li>30 minutes weekly – <strong className="text-green-400">₦60,000.00 per month</strong></li>
            </ul>
          ...
          <motion.div variants={fadeUp} custom={5} className="space-y-2">
            ...
            <ol className="list-decimal pl-6 space-y-1 text-white/90">
          ...
          >
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              className="bg-yellow-400 hover:bg-yellow-500 text-black font-bold py-3 px-10 rounded-full text-lg shadow-xl transition duration-300"
            >
