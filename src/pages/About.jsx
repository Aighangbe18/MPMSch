...
const About = () => {
  return (
    <section className="bg-white text-gray-800">
      ...
      >
        <h2 className="text-2xl font-bold mb-4">Company Summary</h2>
      ...
      <motion.div
        ...
        viewport={{ once: true }}
        variants={fadeInUp}
        className="text-center py-16 bg-indigo-50"
      >
        <h2 className="text-3xl font-semibold mb-4">Meet Our Team</h2>
        <p className="text-gray-600 mb-6">Dedicated and passionate music educators.</p>
        <a
          href="/team"
